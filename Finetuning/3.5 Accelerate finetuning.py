# Distributing training to accelerate (distribute for GPUs)
...
# looks at the environment and initialize the proper distributed setup
...
# send items to the accelerator. This will wrap those objects in the proper container to make sure your distributed training works as intended
